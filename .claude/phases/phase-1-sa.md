...
Шаг 1: Найти kitty-specs/
  Bash(find . -type d -path "*/kitty-specs/*" 2>/dev/null | head -5)

Шаг 2: Прочитать все артефакты (spec.md, research.md, data-model.md, contracts/, checklists/, tasks/)
